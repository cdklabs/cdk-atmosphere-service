...
var require_util2 = __commonJS({
  "node_modules/bluebird/js/release/util.js"(exports, module) {
    ...
    function isObject(value2) {
      return typeof value2 === "function" || typeof value2 === "object" && value2 !== null;
    }
    ...
    function notEnumerableProp(obj2, name, value2) {
    ...
    var ensureErrorObject = function() {
      if (!("stack" in new Error())) {
        return function(value2) {
          if (canAttachTrace(value2)) return value2;
          try {
            throw new Error(safeToString(value2));
          } catch (err) {
            return err;
          }
        };
        ...
        return function(value2) {
          if (canAttachTrace(value2)) return value2;
          return new Error(safeToString(value2));
        };
      }
    }();
    ...
    module2.exports = function(Promise2, INTERNAL) {
      ...
      function doThenable(x, then, context) {
        ...
        function resolve(value2) {
          if (!promise) return;
          promise._resolveCallback(value2);
          promise = null;
        }
...
var require_promise_array = __commonJS({
  "node_modules/bluebird/js/release/promise_array.js"(exports2, module2) {
    ...
    module2.exports = function(Promise2, INTERNAL, tryConvertToPromise, apiRejection, Proxyable) {
      ...
      PromiseArray.prototype._resolve = function(value2) {
        this._values = null;
        this._promise._fulfill(value2);
      };
      ...
      PromiseArray.prototype._promiseFulfilled = function(value2, index) {
...
var require_finally = __commonJS({
  "node_modules/bluebird/js/release/finally.js"(exports2, module2) {
    ...
    module2.exports = function(Promise2, tryConvertToPromise, NEXT_FILTER) {
      ...
      Promise2.prototype._passThrough = function(handler5, type, success2, fail3) {
    ...
    module2.exports = function(Promise2, INTERNAL, tryConvertToPromise, apiRejection, debug) {
      ...
      Promise2.method = function(fn) {
        ...
        return function() {
          ...
          ret2._pushContext();
          var value2 = tryCatch2(fn).apply(this, arguments);
          ...
          ret2._resolveFromSyncValue(value2);
          return ret2;
        };
      };
      Promise2.attempt = Promise2["try"] = function(fn) {
        ...
        if (arguments.length > 1) {
          ...
          var arg = arguments[1];
          var ctx = arguments[2];
          value2 = util.isArray(arg) ? tryCatch2(fn).apply(ctx, arg) : tryCatch2(fn).call(ctx, arg);
        } else {
          value2 = tryCatch2(fn)();
        }
        var promiseCreated = ret2._popContext();
      ...
      Promise2.prototype._resolveFromSyncValue = function(value2) {
        if (value2 === util.errorObj) {
          this._rejectCallback(value2.e, false);
        } else {
          this._resolveCallback(value2, true);
        }
      };
    };
  }
...
var require_bind = __commonJS({
  "node_modules/bluebird/js/release/bind.js"(exports2, module2) {
    ...
    module2.exports = function(Promise2, INTERNAL, tryConvertToPromise, debug) {
      ...
      Promise2.bind = function(thisArg, value2) {
        return Promise2.resolve(value2).bind(thisArg);
      };
    };
  }
});
...
var require_direct_resolve = __commonJS({
  "node_modules/bluebird/js/release/direct_resolve.js"(exports2, module2) {
    ...
    module2.exports = function(Promise2) {
      ...
      Promise2.prototype["return"] = Promise2.prototype.thenReturn = function(value2) {
        if (value2 instanceof Promise2) value2.suppressUnhandledRejections();
        return this._then(
          returner,
          void 0,
          void 0,
...
var require_synchronous_inspection = __commonJS({
  "node_modules/bluebird/js/release/synchronous_inspection.js"(exports2, module2) {
    ...
    module2.exports = function(Promise2) {
      ...
      var value2 = PromiseInspection.prototype.value = function() {
        if (!this.isFulfilled()) {
      ...
      Promise2.prototype.value = function() {
        return value2.call(this._target());
      };
...
var require_generators = __commonJS({
  "node_modules/bluebird/js/release/generators.js"(exports2, module2) {
    ...
    module2.exports = function(Promise2, apiRejection, INTERNAL, tryConvertToPromise, Proxyable, debug) {
      ...
      var tryCatch2 = util.tryCatch;
      var yieldHandlers = [];
      function promiseFromYieldHandler(value2, yieldHandlers2, traceParent) {
        for (var i = 0; i < yieldHandlers2.length; ++i) {
          traceParent._pushContext();
          var result = tryCatch2(yieldHandlers2[i])(value2);
      ...
      PromiseSpawn.prototype._promiseFulfilled = function(value2) {
        this._yieldedPromise = null;
        this._promise._pushContext();
        var result = tryCatch2(this._generator.next).call(this._generator, value2);
        this._promise._popContext();
        this._continue(result);
      };
      ...
      PromiseSpawn.prototype._continue = function(result) {
        ...
        if (result.done === true) {
          ...
          if (this._cancellationPhase) {
            ...
            return promise._resolveCallback(value2);
          }
        } else {
          var maybePromise = tryConvertToPromise(value2, this._promise);
          if (!(maybePromise instanceof Promise2)) {
            ...
            if (maybePromise === null) {
              this._promiseRejected(
                new TypeError2(
                  "A value %s was yielded that could not be treated as a promise\n\n    See http://goo.gl/MqrFmX\n\n".replace("%s", String(value2)) + "From coroutine:\n" + this._stack.split("\n").slice(1, -7).join("\n")
                )
              );
              return;
            }
...
var require_map = __commonJS({
  "node_modules/bluebird/js/release/map.js"(exports2, module2) {
    ...
    module2.exports = function(Promise2, PromiseArray, apiRejection, tryConvertToPromise, INTERNAL, debug) {
      ...
      MappingPromiseArray.prototype._promiseFulfilled = function(value2, index) {
        var values = this._values;
        var length = this.length();
        ...
        if (index < 0) {
          ...
          if (preservedValues !== null) preservedValues[index] = value2;
          var promise = this._promise;
          var callback = this._callback;
          var receiver2 = promise._boundValue();
          promise._pushContext();
          var ret2 = tryCatch2(callback).call(receiver2, value2, index, length);
    ...
    module2.exports = function(Promise2, INTERNAL) {
      ...
      function promisifiableMethods(obj2, suffix, suffixRegexp, filter) {
        ...
        for (var i = 0; i < keys.length; ++i) {
          var key = keys[i];
          var value2 = obj2[key];
          var passesDefaultFilter = filter === defaultFilter ? true : defaultFilter(key, value2, obj2);
          if (typeof value2 === "function" && !isPromisified(value2) && !hasPromisified(obj2, key, suffix) && filter(key, value2, obj2, passesDefaultFilter)) {
            ret2.push(key, value2);
          }
        }
      ...
      Promise2.promisifyAll = function(target, options) {
        ...
        for (var i = 0; i < keys.length; ++i) {
          var value2 = target[keys[i]];
          if (keys[i] !== "constructor" && util.isClass(value2)) {
            promisifyAll(
              value2.prototype,
              suffix,
              filter,
            ...
            promisifyAll(value2, suffix, filter, promisifier, multiArgs);
          }
        }
  ...
  "node_modules/bluebird/js/release/props.js"(exports2, module2) {
    ...
    module2.exports = function(Promise2, PromiseArray, tryConvertToPromise, apiRejection) {
      ...
      var mapToEntries = /* @__PURE__ */ function() {
        var index = 0;
        var size = 0;
        function extractEntry(value2, key) {
          this[index] = value2;
          this[index + size] = key;
          index++;
        }
      ...
      PropertiesPromiseArray.prototype._promiseFulfilled = function(value2, index) {
        this._values[index] = value2;
        var totalResolved = ++this._totalResolved;
        if (totalResolved >= this._length) {
          var val;
...
var require_reduce = __commonJS({
  "node_modules/bluebird/js/release/reduce.js"(exports2, module2) {
    ...
    module2.exports = function(Promise2, PromiseArray, apiRejection, tryConvertToPromise, INTERNAL, debug) {
      ...
      ReductionPromiseArray.prototype._eachComplete = function(value2) {
        if (this._eachValues !== null) {
          this._eachValues.push(value2);
        }
      ...
      ReductionPromiseArray.prototype._resolve = function(value2) {
        this._promise._resolveCallback(value2);
        this._values = null;
      };
      ...
      ReductionPromiseArray.prototype._iterate = function(values) {
        ...
        if (!value2.isRejected()) {
          for (; i < length; ++i) {
            ...
            value2 = value2._then(gotAccum, void 0, void 0, ctx, void 0);
            if ((i & 127) === 0) {
              value2._setNoAsyncGuarantee();
            }
          }
        }
        if (this._eachValues !== void 0) {
          value2 = value2._then(this._eachComplete, void 0, void 0, this, void 0);
        }
        value2._then(completed, completed, void 0, value2, this);
      };
      ...
      function gotAccum(accum) {
        ...
        var value2 = tryConvertToPromise(this.value, this.array._promise);
        if (value2 instanceof Promise2) {
          this.array._currentCancellable = value2;
          return value2._then(gotValue, void 0, void 0, this, void 0);
        } else {
          return gotValue.call(this, value2);
        }
      }
      function gotValue(value2) {
        ...
        if (array._eachValues !== void 0) {
          ret2 = fn.call(promise._boundValue(), value2, this.index, this.length);
        } else {
          ret2 = fn.call(
            promise._boundValue(),
            this.accum,
...
var require_settle = __commonJS({
  "node_modules/bluebird/js/release/settle.js"(exports2, module2) {
    ...
    module2.exports = function(Promise2, PromiseArray, debug) {
      ...
      SettledPromiseArray.prototype._promiseFulfilled = function(value2, index) {
        var ret2 = new PromiseInspection();
        ret2._bitField = 33554432;
        ret2._settledValueField = value2;
...
var require_some = __commonJS({
  "node_modules/bluebird/js/release/some.js"(exports2, module2) {
    ...
    module2.exports = function(Promise2, PromiseArray, apiRejection) {
      ...
      SomePromiseArray.prototype._promiseFulfilled = function(value2) {
        this._addFulfilled(value2);
      ...
      SomePromiseArray.prototype._addFulfilled = function(value2) {
        this._values[this._totalResolved++] = value2;
      };
...
var require_timers = __commonJS({
  "node_modules/bluebird/js/release/timers.js"(exports2, module2) {
    ...
    module2.exports = function(Promise2, INTERNAL, debug) {
      ...
      var afterValue = function(value2) {
        return delay(+this).thenReturn(value2);
      };
      var delay = Promise2.delay = function(ms, value2) {
        var ret2;
        var handle;
        if (value2 !== void 0) {
          ret2 = Promise2.resolve(value2)._then(afterValue, null, null, ms, void 0);
          if (debug.cancellation() && value2 instanceof Promise2) {
            ret2._setOnCancel(value2);
          }
        } else {
...
var require_using = __commonJS({
  "node_modules/bluebird/js/release/using.js"(exports2, module2) {
    ...
    module2.exports = function(Promise2, apiRejection, tryConvertToPromise, createContext, INTERNAL, debug) {
      ...
      function maybeUnwrapDisposer(value2) {
        if (Disposer.isDisposer(value2)) {
          this.resources[this.index]._setDisposable(value2);
          return value2.promise();
        }
        return value2;
      }
...
var require_promise = __commonJS({
  "node_modules/bluebird/js/release/promise.js"(exports2, module2) {
    ...
    module2.exports = function() {
      ...
      Promise2.prototype._resolveCallback = function(value2, shouldBind) {
        if ((this._bitField & 117506048) !== 0) return;
        if (value2 === this)
          return this._rejectCallback(makeSelfResolutionError(), false);
        var maybePromise = tryConvertToPromise(value2, this);
        if (!(maybePromise instanceof Promise2)) return this._fulfill(value2);
      ...
      Promise2.prototype._resolveFromExecutor = function(executor) {
        ...
        this._pushContext();
        var synchronous = true;
        var r = this._execute(executor, function(value2) {
          promise._resolveCallback(value2);
        }, function(reason) {
      ...
      Promise2.prototype._settlePromiseFromHandler = function(handler5, receiver2, value2, promise) {
        ...
        var x;
        if (receiver2 === APPLY) {
          if (!value2 || typeof value2.length !== "number") {
            x = errorObj2;
      ...
      Promise2.prototype._settlePromise = function(promise, handler5, receiver2, value2) {
        ...
        if ((bitField & 65536) !== 0) {
          ...
          if (!receiver2._isResolved()) {
            if ((bitField & 33554432) !== 0) {
              receiver2._promiseFulfilled(value2, promise);
            } else {
              receiver2._promiseRejected(value2, promise);
            }
          }
        } else if (isPromise) {
          if (asyncGuaranteed) promise._setAsyncGuaranteed();
      ...
      Promise2.prototype._fulfill = function(value2) {
        var bitField = this._bitField;
        ...
        this._setFulfilled();
        this._rejectionHandler0 = value2;
        if ((bitField & 65535) > 0) {
      ...
      Promise2.prototype._settlePromises = function() {
        ...
        if (len > 0) {
          if ((bitField & 16842752) !== 0) {
            ...
            var value2 = this._rejectionHandler0;
            this._settlePromise0(this._fulfillmentHandler0, value2, bitField);
            this._fulfillPromises(len, value2);
          }
          this._setLength(0);
        }
      ...
      function fillTypes(value2) {
        var p = new Promise2(INTERNAL);
        p._fulfillmentHandler0 = value2;
        p._rejectionHandler0 = value2;
        p._promise0 = value2;
        p._receiver0 = value2;
      }
      fillTypes({ a: 1 });
...
// src/cleanup/cleaner.bucket.ts
var import_client_s3 = require("@aws-sdk/client-s3");
var BucketCleaner = class {
  constructor(s33) {
    this.s3 = s33;
  }
  async empty(opts) {
    ...
    while (isTruncated) {
      ...
      if (objectsToDelete.length > 0) {
        ...
        await this.s3.send(new import_client_s3.DeleteObjectsCommand(deleteCommand));
...
var Cleaner = class {
  constructor(environment) {
    ...
    this.cfn = new import_client_cloudformation.CloudFormation({ credentials: this.credentials, region: this.environment.region });
  }
  ...
  async deleteStack(stack, timeoutDate) {
    ...
    try {
      if (stack.StackStatus !== "DELETE_IN_PROGRESS") {
        ...
        const bucketCleaner = new BucketCleaner(new import_client_s32.S3({ credentials: this.credentials, region: this.environment.region }));
...
var s32 = new import_client_s33.S3();
...
var Session = class _Session {
  ...
  static async create(sessionName) {
    ...
    const stacksBucket = Envars.optional("CDK_ATMOSPHERE_INTEG_STACKS_BUCKET");
    const stacksKey = Envars.optional("CDK_ATMOSPHERE_INTEG_STACKS_KEY");
    if (stacksBucket && stacksKey) {
      stacksBasePath = "/tmp/stacks";
      await _Session.unzip(stacksBucket, stacksKey, stacksBasePath);
    }
    return new _Session({
  ...
  async cleanupRemote(req) {
    ...
    const waitTime = req.timeoutSeconds + 60;
    this.log(`Waiting ${waitTime} seconds for cleanup task ${taskInstanceArn} to stop`);
    await this.waitFor(async () => await this.fetchStoppedCleanupTask(req.allocationId) !== void 0, waitTime);
  }
...
async function handler4(_) {
  ...
  await Session.assert(async (session) => {
    ...
    const s33 = new import_client_s34.S3({ region });
