...
var require_Unit = __commonJS({
  "node_modules/aws-embedded-metrics/lib/logger/Unit.js"(exports2) {
    ...
    var Unit4;
    (function(Unit5) {
      Unit5["Seconds"] = "Seconds";
      Unit5["Microseconds"] = "Microseconds";
      Unit5["Milliseconds"] = "Milliseconds";
      Unit5["Bytes"] = "Bytes";
      Unit5["Kilobytes"] = "Kilobytes";
      Unit5["Megabytes"] = "Megabytes";
      Unit5["Gigabytes"] = "Gigabytes";
      Unit5["Terabytes"] = "Terabytes";
      Unit5["Bits"] = "Bits";
      Unit5["Kilobits"] = "Kilobits";
      Unit5["Megabits"] = "Megabits";
      Unit5["Gigabits"] = "Gigabits";
      Unit5["Terabits"] = "Terabits";
      Unit5["Percent"] = "Percent";
      Unit5["Count"] = "Count";
      Unit5["BytesPerSecond"] = "Bytes/Second";
      Unit5["KilobytesPerSecond"] = "Kilobytes/Second";
      Unit5["MegabytesPerSecond"] = "Megabytes/Second";
      Unit5["GigabytesPerSecond"] = "Gigabytes/Second";
      Unit5["TerabytesPerSecond"] = "Terabytes/Second";
      Unit5["BitsPerSecond"] = "Bits/Second";
      Unit5["KilobitsPerSecond"] = "Kilobits/Second";
      Unit5["MegabitsPerSecond"] = "Megabits/Second";
      Unit5["GigabitsPerSecond"] = "Gigabits/Second";
      Unit5["TerabitsPerSecond"] = "Terabits/Second";
      Unit5["CountPerSecond"] = "Count/Second";
      Unit5["None"] = "None";
    })(Unit4 = exports2.Unit || (exports2.Unit = {}));
  }
});
...
async function handler5(event) {
  return RuntimeMetrics.scoped(async (metrics) => {
    try {
      const response = await doHandler3(event, metrics);
