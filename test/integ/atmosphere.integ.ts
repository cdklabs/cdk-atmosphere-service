...
export class AtmosphereIntegTest {
  ...
  constructor(props: AtmosphereIntegTestProps) {
    ...
    const envVariables: envars.EnvironmentVariables = {
      ...
      [envars.ALLOCATION_TIMEOUT_LOG_GROUP_NAME_ENV]: service.scheduler.allocationTimeout.function.logGroup.logGroupName,
      [envars.CLEANUP_TIMEOUT_LOG_GROUP_NAME_ENV]: service.scheduler.cleanupTimeout.function.logGroup.logGroupName,
