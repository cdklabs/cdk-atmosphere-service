...
var require_Unit = __commonJS({
  "node_modules/aws-embedded-metrics/lib/logger/Unit.js"(exports2) {
    ...
    var Unit6;
    (function(Unit7) {
      Unit7["Seconds"] = "Seconds";
      Unit7["Microseconds"] = "Microseconds";
      Unit7["Milliseconds"] = "Milliseconds";
      Unit7["Bytes"] = "Bytes";
      Unit7["Kilobytes"] = "Kilobytes";
      Unit7["Megabytes"] = "Megabytes";
      Unit7["Gigabytes"] = "Gigabytes";
      Unit7["Terabytes"] = "Terabytes";
      Unit7["Bits"] = "Bits";
      Unit7["Kilobits"] = "Kilobits";
      Unit7["Megabits"] = "Megabits";
      Unit7["Gigabits"] = "Gigabits";
      Unit7["Terabits"] = "Terabits";
      Unit7["Percent"] = "Percent";
      Unit7["Count"] = "Count";
      Unit7["BytesPerSecond"] = "Bytes/Second";
      Unit7["KilobytesPerSecond"] = "Kilobytes/Second";
      Unit7["MegabytesPerSecond"] = "Megabytes/Second";
      Unit7["GigabytesPerSecond"] = "Gigabytes/Second";
      Unit7["TerabytesPerSecond"] = "Terabytes/Second";
      Unit7["BitsPerSecond"] = "Bits/Second";
      Unit7["KilobitsPerSecond"] = "Kilobits/Second";
      Unit7["MegabitsPerSecond"] = "Megabits/Second";
      Unit7["GigabitsPerSecond"] = "Gigabits/Second";
      Unit7["TerabitsPerSecond"] = "Terabits/Second";
      Unit7["CountPerSecond"] = "Count/Second";
      Unit7["None"] = "None";
    })(Unit6 = exports2.Unit || (exports2.Unit = {}));
  }
});
  ...
  "node_modules/aws-embedded-metrics/lib/logger/MetricScope.js"(exports2) {
    ...
    var metricScope = (handler7) => {
      const wrappedHandler = (...args) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
          return yield handler7(metrics)(...args);
        } finally {
          try {
            yield metrics.flush();
          } catch (e) {
...
var import_aws_embedded_metrics2 = __toESM(require_lib2());
...
var METRIC_NAME2 = "allocation-timeout";
var METRIC_DIMENSION_RESULT = "result";
var clients2 = RuntimeClients.getOrCreate();
async function handler2(event) {
  return RuntimeMetrics.scoped(async (metrics) => {
    try {
      await doHandler2(event, metrics);
      metrics.putDimensions({ [METRIC_DIMENSION_RESULT]: "success" });
    } catch (e) {
      metrics.putDimensions({ [METRIC_DIMENSION_RESULT]: "error" });
      throw e;
    } finally {
      metrics.delegate.putMetric(METRIC_NAME2, 1, import_aws_embedded_metrics3.Unit.Count);
    }
  });
}
async function doHandler2(event, metrics) {
  console.log("Event:", JSON.stringify(event, null, 2));
...
var import_aws_embedded_metrics4 = __toESM(require_lib2());
...
async function handler3(req) {
  await RuntimeMetrics.scoped(async (metrics) => {
    let exitCode = 0;
    try {
      await doHandler3(req, metrics);
    } catch (e) {
      exitCode = 1;
      throw e;
    } finally {
      metrics.putDimensions({ [METRIC_DIMENSION_EXIT_CODE]: exitCode.toString() });
      metrics.delegate.putMetric(METRIC_NAME3, 1, import_aws_embedded_metrics4.Unit.Count);
    }
  });
}
async function doHandler3(req, metrics) {
...
var import_aws_embedded_metrics5 = __toESM(require_lib2());
var METRIC_NAME4 = "allocation-timeout";
var METRIC_DIMENSION_RESULT2 = "result";
var clients4 = RuntimeClients.getOrCreate();
async function handler4(event) {
  return RuntimeMetrics.scoped(async (metrics) => {
    try {
      await doHandler4(event, metrics);
      metrics.putDimensions({ [METRIC_DIMENSION_RESULT2]: "success" });
    } catch (e) {
      metrics.putDimensions({ [METRIC_DIMENSION_RESULT2]: "error" });
      throw e;
    } finally {
      metrics.delegate.putMetric(METRIC_NAME4, 1, import_aws_embedded_metrics5.Unit.Count);
    }
  });
}
async function doHandler4(event, metrics) {
  console.log("Event:", JSON.stringify(event, null, 2));
...
var import_aws_embedded_metrics6 = __toESM(require_lib2());
...
async function handler5(event) {
  return RuntimeMetrics.scoped(async (metrics) => {
    try {
      const response = await doHandler5(event, metrics);
      metrics.putDimensions({ [METRIC_DIMENSION_STATUS_CODE2]: response.statusCode.toString() });
      return response;
    } finally {
      metrics.delegate.putMetric(METRIC_NAME5, 1, import_aws_embedded_metrics6.Unit.Count);
    }
  });
}
async function doHandler5(event, metrics) {
  console.log("Event:", JSON.stringify(event, null, 2));
...
var Runtime = class _Runtime {
  ...
  async allocationTimeoutLocal(event) {
    ...
    console.log("");
    await env2(this.vars, async () => handler2(event));
    console.log("");
  }
...
async function handler6(_) {
  await Runner.assert("creates-the-right-resources", async (session) => {
    ...
    await clients7.allocations.scan(from);
