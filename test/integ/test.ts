...
import { SUCCESS_PAYLOAD } from './session';
...
export class AtmosphereIntegTest extends Construct {
  ...
  constructor(scope: Construct, id: string, props: IntegTestAtmosphereServiceProps) {
    ...
    this.integ = new IntegTest(this, 'IntegTest', {
      testCases: [cdk.Stack.of(this)],

      // place assertions in the same stack because it makes it easier
      // to manually cleanup and avoids cross stack refrences.
      assertionStack: cdk.Stack.of(this),
