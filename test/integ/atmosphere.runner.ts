...
export class Runner {
  ...
  private static async create(testCase: string): Promise<Runner> {
    ...
    return new Runner({
      ...
      [envars.ALLOCATE_LOG_GROUP_NAME_ENV]: envValue(envars.ALLOCATE_LOG_GROUP_NAME_ENV),
      [envars.DEALLOCATE_LOG_GROUP_NAME_ENV]: envValue(envars.DEALLOCATE_LOG_GROUP_NAME_ENV),
      [envars.ALLOCATION_TIMEOUT_LOG_GROUP_NAME_ENV]: envValue(envars.ALLOCATION_TIMEOUT_LOG_GROUP_NAME_ENV),
      [envars.CLEANUP_TIMEOUT_LOG_GROUP_NAME_ENV]: envValue(envars.CLEANUP_TIMEOUT_LOG_GROUP_NAME_ENV),
      ...
      [envars.CLEANUP_LOG_GROUP_NAME_ENV]: envValue(envars.CLEANUP_LOG_GROUP_NAME_ENV),
