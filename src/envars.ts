...
export const ALLOCATE_LOG_GROUP_NAME_ENV = `${ENV_PREFIX}ALLOCATE_LOG_GROUP_NAME`;
export const DEALLOCATE_LOG_GROUP_NAME_ENV = `${ENV_PREFIX}DEALLOCATE_LOG_GROUP_NAME`;
export const ALLOCATION_TIMEOUT_LOG_GROUP_NAME_ENV = `${ENV_PREFIX}ALLOCATION_TIMEOUT_LOG_GROUP_NAME`;
export const CLEANUP_TIMEOUT_LOG_GROUP_NAME_ENV = `${ENV_PREFIX}CLEANUP_TIMEOUT_LOG_GROUP_NAME`;
...
export const CLEANUP_LOG_GROUP_NAME_ENV = `${ENV_PREFIX}CLEANUP_LOG_GROUP_NAME`;
...
export type EnvironmentVariables = {
  ...
  [ALLOCATE_LOG_GROUP_NAME_ENV]: string;
  [DEALLOCATE_LOG_GROUP_NAME_ENV]: string;
  [ALLOCATION_TIMEOUT_LOG_GROUP_NAME_ENV]: string;
  [CLEANUP_TIMEOUT_LOG_GROUP_NAME_ENV]: string;
  ...
  [CLEANUP_LOG_GROUP_NAME_ENV]: string;
