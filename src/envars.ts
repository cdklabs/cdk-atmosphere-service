...
export const ALLOCATION_TIMEOUT_DLQ_ARN_ENV = `${ENV_PREFIX}ALLOCATION_TIMEOUT_DLQ_ARN`;
export const CLEANUP_TIMEOUT_DLQ_ARN_ENV = `${ENV_PREFIX}CLEANUP_TIMEOUT_DLQ_ARN`;
...
export type EnvironmentVariables = {
  ...
  [ALLOCATION_TIMEOUT_DLQ_ARN_ENV]: string;
  [CLEANUP_TIMEOUT_DLQ_ARN_ENV]: string;
